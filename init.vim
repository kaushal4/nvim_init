"filetype plugin is for nerd commenter
filetype plugin on
"nerd commenter rules
...
" the below is the plugin manager ehich is as far as I know vim-plug
call plug#begin()
...
" the below script is to enable mouse support (forced due to documentation
" scrolling)
set mouse=a

" the below scripts are to change focus on split screens
...
"mappings for floar using has_float()
